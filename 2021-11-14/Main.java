...
// в метое main создать несколько книг, сделать массив из них и вызвать описание каждой книги из массива. (отредактировано)
        Book book1 = new Book(1, "Author1", 15);
        Book book2 = new TechnicalBook(2, "Author2", 10, "Mathe");
        Book book3 = new LiteratureBook(3, "Author3", 23);
        Book book4 = new BestSeller(4, "Author4", 5, 1.33);
    ...
    static String describeBook(Book book) {
        return book.getId() + "\t" +  book.getAuthor() + "\t" + book.getPrice() + "\t"+ book.computePrice();
    }
}
